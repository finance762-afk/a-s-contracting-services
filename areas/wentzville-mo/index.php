...
$citySlug        = 'wentzville-mo';
$pageTitle       = "Contractor in Wentzville, MO | A&S Contracting Services | St. Charles County";
...
$bodyPhoto1 = $pb . '1779985049692-2gmyz6-31-Mar_13__2025_16-36-11-MGgp.jpg';
$bodyPhoto2 = $pb . '1779985081293-864e8m-2-Feb_09__2026_13-42-04-ptJL.jpg';
    ...
    '@graph'   => [
        [
            ...
            'itemListElement' => [
                ...
                ['@type' => 'ListItem', 'position' => 3, 'name' => 'Wentzville, MO'],
            ],
        ],
        [
            '@type'       => 'Service',
            'name'        => 'General Contractor in Wentzville, MO',
            'description' => 'Licensed general contractor based in Warrenton, MO serving Wentzville and St. Charles County with roofing, siding, gutters, windows, drywall, and interior renovations.',
...
<style>
/* ============================================================
   /areas/wentzville-mo/ — Premium Area Page — A&S Contracting
   Signature technique: growth-city grid pattern accent overlay
   ============================================================ */
...
.city-hero::before {
  ...
  position: absolute;
  inset: 0;
  background: linear-gradient(115deg, rgba(var(--color-primary-rgb), 0.96) 0%, rgba(var(--color-primary-rgb), 0.80) 50%, rgba(var(--color-primary-rgb), 0.28) 100%);
  z-index: 1;
}
.city-hero::after {
  content: '';
...
/* Signature: growth-city dot-grid pattern in hero right half */
.city-hero .hero-grid-pattern {
  position: absolute;
  right: 0;
  top: 0;
  bottom: 0;
  width: 42%;
  background-image: radial-gradient(circle, rgba(var(--color-accent-rgb), 0.12) 1px, transparent 1px);
...
.hero-eyebrow-badge {
  ...
  padding: 5px 12px; border-radius: var(--radius-sm); margin-bottom: var(--space-md);
}
.city-hero h1 {
  font-family: var(--font-heading,'Unbounded',sans-serif);
  font-size: clamp(2rem,4vw,3.2rem);
  font-weight: 800; line-height: 1.08; text-wrap: balance;
...
.trust-pill {
  ...
  color: rgba(255,255,255,0.88); font-size: 0.82rem; font-weight: 600; padding: 6px 14px; border-radius: 100px;
}
.trust-pill svg { width: 13px; height: 13px; color: var(--color-accent); }
.hero-cta-row { display: flex; gap: var(--space-md); flex-wrap: wrap; }
.btn-primary-city {
  display: inline-flex; align-items: center; gap: 8px; background: var(--color-accent); color: var(--color-primary);
  font-family: var(--font-heading,'Unbounded',sans-serif); font-size: 0.82rem; font-weight: 800;
  padding: 14px 28px; border-radius: var(--radius); border: 2px solid var(--color-accent);
...
.btn-ghost-city {
  ...
  color: var(--color-secondary); font-family: var(--font-heading,'Unbounded',sans-serif);
  font-size: 0.82rem; font-weight: 700; padding: 14px 28px; border-radius: var(--radius);
  border: 2px solid rgba(255,255,255,0.3); transition: all 0.2s; text-transform: uppercase; letter-spacing: 0.04em;
}
...
<!-- HERO -->
<section class="city-hero" aria-label="General contractor services in Wentzville, MO">
  ...
  <div class="city-hero-inner">
    <div>
      <nav class="hero-breadcrumb" aria-label="Breadcrumb">
        ...
        <span aria-current="page">Wentzville, MO</span>
      </nav>
      <span class="hero-eyebrow-badge">St. Charles County — Growing Fast</span>
      <h1>General Contractor in <span class="accent">Wentzville, MO</span> — Built for Missouri's Fastest-Growing City</h1>
      <p class="hero-answer">A&S Contracting Services serves Wentzville from our Warrenton base — 20 miles west on I-70. We handle roofing, siding, gutters, windows, drywall, and full interior renovations for Wentzville homeowners. Free written estimates across St. Charles County.</p>
      ...
      <div class="hero-cta-row">
        <a href="/contact/" class="btn-primary-city">Get a Free Estimate in Wentzville</a>
        <a href="/services/" class="btn-ghost-city">View All Services</a>
      </div>
    </div>
    <aside class="hero-form-card" aria-label="Quick estimate form">
      <p class="form-card-title">Free Estimate — Wentzville, MO</p>
      <p class="form-card-subtitle">Tell us about your project and we'll schedule an estimate fast.</p>
      <form class="city-form" action="<?php echo htmlspecialchars($formAction); ?>" method="POST">
        ...
        <div class="fg"><label for="wz-name">Your Name</label><input type="text" id="wz-name" name="name" placeholder="Jane Smith" required></div>
        <div class="fg"><label for="wz-phone">Phone</label><input type="tel" id="wz-phone" name="phone" placeholder="(636) 555-0100" required></div>
        <div class="fg"><label for="wz-email">Email</label><input type="email" id="wz-email" name="email" placeholder="you@email.com" required></div>
        <div class="fg">
          <label for="wz-service">Service Needed</label>
          <select id="wz-service" name="service">
...
<!-- IDENTITY / ANSWER -->
<section class="identity-section" aria-label="About A&S Contracting in Wentzville">
  <div class="ctr">
    <div class="identity-grid">
      <div class="reveal-scale">
        <div class="identity-img-wrap">
          <img src="<?php echo $bodyPhoto1; ?>" alt="A&S Contracting Services crew working on a Wentzville, MO home" width="760" height="420" loading="lazy">
          <div class="identity-img-badge">
            ...
            Serving <span>Wentzville</span>, MO
          </div>
        </div>
      </div>
      <div class="reveal-right">
        <span class="eyebrow">St. Charles County Coverage</span>
        <h2 class="sec-h2">Serving <span style="color:var(--color-accent);">Wentzville's new developments</span> and established neighborhoods</h2>
        <div class="answer-block">
          A&S Contracting Services is a licensed and insured general contractor based in Warrenton, MO — 20 miles west of Wentzville. We serve Wentzville homeowners in St. Charles County with roofing, siding, gutters, soffit, fascia, windows, drywall, and full interior renovations. Estimate windows of 3–6 business days for Wentzville projects.
        </div>
        <p class="prose-block">Wentzville is one of Missouri's fastest-growing cities — and with rapid growth comes rapid need for contractors who can keep up. We work in Heritage of Hawk Ridge, the Bryan Crossing area, Arbor developments, and the established neighborhoods closer to Wentzville's original downtown on Main Street.</p>
        <p class="prose-block">Missouri's climate affects St. Charles County just as hard as Warren County — spring hail, summer heat expansion, and winter freeze-thaw cycles stress roofing and exterior systems. We know which materials perform best in this climate and install them to manufacturer specs. If you're looking for a contractor near me in Wentzville, MO, A&S covers your area.</p>
        <div class="stat-row">
          <div class="stat-item">
...
<!-- LOCAL DETAIL -->
<section class="local-section" aria-label="Wentzville, MO neighborhoods and local details">
  <div class="ctr">
    <div class="local-grid">
      <div class="reveal-left">
        <span class="eyebrow">Wentzville, St. Charles County</span>
        <h2 class="sec-h2">Where we work in <span style="color:var(--color-accent);">Wentzville and surrounding St. Charles County</span></h2>
        <p class="prose-block">Wentzville sits at the junction of I-70 and Wentzville Parkway, making it one of the most accessible communities in the metro region. From Lake Saint Louis to the west to Foristell to the east, the entire eastern edge of our service territory runs through Wentzville's zip codes.</p>
        <p class="prose-block">New construction here tends to have builder-grade roofing and gutters that hit their warranty limit around the 10–15 year mark. We see a lot of first-time replacement projects in Wentzville's 2005–2015 build wave — homes that were built fast and are now ready for proper material upgrades.</p>
        <ul class="local-detail-list">
          <li><span class="ck-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg></span>Heritage of Hawk Ridge and Arbor at Bryan Crossing</li>
          <li><span class="ck-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg></span>Wentzville Parkway and Route 40/61 corridor neighborhoods</li>
          <li><span class="ck-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg></span>Wentzville R-IV School District family homes</li>
          <li><span class="ck-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg></span>Lake Saint Louis and Foristell homes on the county line</li>
          <li><span class="ck-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg></span>Permit pulls for Wentzville city proper and St. Charles County</li>
        </ul>
      </div>
      <div class="local-sidebar reveal-right">
        <div class="landmark-card">
          <p class="landmark-name">Wentzville Parkway Corridor</p>
          <p class="landmark-desc">High-density residential development along the parkway includes homes now due for roofing replacements and gutter system upgrades.</p>
        </div>
        <div class="landmark-card">
          <p class="landmark-name">Bryan Crossing / Heritage Areas</p>
          <p class="landmark-desc">Newer subdivisions with 2010s construction — siding touch-ups, window seal failures, and first-gen gutter replacement are common in these neighborhoods.</p>
        </div>
        <div class="landmark-card">
          <p class="landmark-name">Wentzville R-IV School Area</p>
          <p class="landmark-desc">Family-dense neighborhoods surrounding the Wentzville school campuses — one of our most active project zones in St. Charles County.</p>
        </div>
        <div class="landmark-card">
          <p class="landmark-name">Lake Saint Louis Overlap</p>
          <p class="landmark-desc">Lake Saint Louis homes on the western St. Charles County edge are within our territory. We serve lakeside properties with exterior and interior renovation work.</p>
        </div>
      </div>
    </div>
  </div>
...
<!-- SERVICES STRIP -->
<section class="services-area-section" aria-label="Services available in Wentzville, MO">
  <div class="ctr">
    <div style="text-align:center;margin-bottom:var(--space-sm);">
      <span class="eyebrow">Available in Wentzville</span>
      <h2 class="sec-h2">All 10 A&S services available in <span style="color:var(--color-accent);">Wentzville, MO</span></h2>
      <div class="answer-block" style="margin:var(--space-md) auto;text-align:left;max-width:64ch;">Every service A&S Contracting offers — roofing, siding, gutters, soffit, fascia, windows &amp; doors, drywall, interior renovations, exterior work, and general contracting — is available in Wentzville. Distance doesn't affect pricing or quality within our territory.</div>
    </div>
...
<!-- WHY A&S -->
<section class="why-section" aria-label="Why choose A&S Contracting in Wentzville">
  <div class="ctr">
    <div class="why-grid">
      <div class="reveal-left">
        <span class="eyebrow" style="color:var(--color-accent);">Why A&S for Wentzville</span>
        <h2 class="sec-h2-light">Why Wentzville homeowners choose <span style="color:var(--color-accent);">A&S over local St. Charles County contractors</span></h2>
        <ul class="why-list">
          <li class="why-item">
            ...
            <div>
              <p class="why-item-title">Licensed to Pull Permits in St. Charles County</p>
              <p class="why-item-desc">A&S is a Missouri-licensed general contractor. We handle permit applications for Wentzville city projects and St. Charles County jobs — inspections, sign-offs, and final approvals managed for you.</p>
            </div>
          </li>
          <li class="why-item">
            ...
            <div>
              <p class="why-item-title">Full-Scope — No Subcontractor Patchwork</p>
              <p class="why-item-desc">Unlike smaller Wentzville contractors who subcontract roofing, siding, and drywall to separate crews, A&S manages the full scope in-house. One crew, one point of contact, no coordination gaps.</p>
            </div>
          </li>
          <li class="why-item">
            ...
            <div>
              <p class="why-item-title">Newer-Construction Expertise</p>
              <p class="why-item-desc">Wentzville's rapid growth means most homes here were built in the 2000s–2010s. We know what builder-grade materials age like and what replacement options give you the longest service life for your dollar.</p>
            </div>
          </li>
          <li class="why-item">
            ...
            <div>
              <p class="why-item-title">No-Surprise Written Estimates</p>
              <p class="why-item-desc">Every Wentzville estimate is in-person and written. We visit your home, measure, inspect, and deliver a detailed breakdown — no phone estimates, no scope creep at job start.</p>
            </div>
          </li>
        </ul>
      </div>
      <div class="why-img-wrap reveal-right">
        <img src="<?php echo $bodyPhoto2; ?>" alt="A&S Contracting Services project in Wentzville, MO" width="640" height="460" loading="lazy">
...
<!-- CTA -->
<section class="cta-section" aria-label="Get a free estimate in Wentzville, MO">
  <div class="ctr">
    ...
    <span class="eyebrow">Wentzville, MO Homeowners</span>
    <h2 class="sec-h2" style="max-width:560px;margin:var(--space-sm) auto var(--space-md);">Get a Free Estimate in <span style="color:var(--color-accent);">Wentzville, MO</span></h2>
    <p class="cta-subtitle">A&S Contracting Services covers all of Wentzville and St. Charles County. We'll come out to your property, assess the scope, and hand you a written quote — no obligation to move forward.</p>
    ...
    <p style="margin-top:var(--space-lg);font-size:0.85rem;color:var(--color-text-light);">Last Updated: <?php echo date('F Y'); ?> — Serving Wentzville, MO and St. Charles County.</p>
  </div>
</section>
