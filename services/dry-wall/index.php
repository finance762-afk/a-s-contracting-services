...
<?php
$thisSlug        = 'dry-wall';
$pageTitle       = "Drywall Installation & Repair in Warrenton, MO | A&S Contracting Services";
$pageDescription = "Professional drywall installation, finishing, and repair in Warrenton, MO. Level 3–5 finish, water damage rebuilds, new construction. Warren County — free estimates.";
$canonicalUrl    = $siteUrl . '/services/dry-wall/';
$currentPage     = 'dry-wall';
$cssVersion      = '5';
...
$bodyPhoto1      = $pb . '1779985139581-wvg3mc-4-Jan_16__2025_20-17-47-EJSE.jpg';
$bodyPhoto2      = $pb . '1779985139935-6suds2-6-Jan_16__2025_20-19-09-vQZq.jpg';
$bodyPhoto3      = $pb . '1779985188297-sg808o-38-Jul_17__2024_23-21-26-ioE1.jpg';
...
$relSlugs  = ['full-scale-interior-work','general-contracting','exterior-work'];
$relPhotos = [
...
$relIcons   = ['full-scale-interior-work'=>'home','general-contracting'=>'hard-hat','exterior-work'=>'hammer'];
$relBullets = [
    ...
    'exterior-work'            => ['Complete exterior renovation','All systems coordinated','50-mile service radius'],
];

$faqs = [
    ['question'=>'What drywall services does A&S offer in Warrenton, MO?','answer'=>'A&S Contracting Services provides drywall installation for new construction and renovation, drywall finishing from Level 3 through Level 5 (smooth), patch and repair for water damage or impact holes, and ceiling drywall installation. We serve residential and commercial projects throughout Warrenton, MO and Warren County, MO.'],
    ['question'=>'What is the difference between Level 3, 4, and 5 drywall finish?','answer'=>'Level 3 finish is the minimum for textured ceilings — tape and compound applied, not sanded smooth. Level 4 is the standard residential finish — properly sanded for standard paint, suitable for flat or eggshell sheens. Level 5 is a skim-coat finish applied over the entire surface — the highest grade, required for gloss or semi-gloss paints and preferred on walls where light rakes across the surface and reveals any imperfection.'],
    ['question'=>'How much does drywall installation cost in Warren County?','answer'=>'Drywall installation in the Warrenton area typically ranges from $1.80 to $3.50 per square foot installed, depending on panel size, height, finish level, and project conditions. Water damage rebuilds — which require demo, mold remediation coordination, and patching — are quoted per scope. A&S provides free written estimates with no obligation.'],
    ['question'=>'Can you match existing drywall texture when doing patch repairs?','answer'=>'Yes. Texture matching is one of the most common requests we receive in Warren County — patch repairs after ceiling fan installations, pipe access, or water damage. We match knock-down, orange peel, skip trowel, and smooth finishes. We recommend against attempting texture matching without seeing the existing surface in person, which is why our estimates always include an on-site inspection.'],
    ['question'=>'Do you handle drywall after water damage repairs in Warrenton?','answer'=>'Yes. Water damage drywall work is among the most common scopes we handle — typically after roof leaks, pipe bursts, or HVAC condensation issues. We remove damaged sections, coordinate with the homeowner on any required mold testing, install new drywall, finish to the agreed level, and prime for paint. We do not perform mold remediation directly, but we work alongside remediation contractors when needed.'],
    ['question'=>'How long does drywall installation or repair take near Warrenton?','answer'=>'A single room drywall installation with Level 4 finish typically takes 3–5 days including drying time between coats. A full-home drywall project is usually 1–2 weeks. Patch repairs range from a few hours to 2–3 days depending on the extent of damage. Drying time between coats — typically 24 hours per coat — is the primary variable and cannot be shortened without risking adhesion and finish quality.'],
];

$schemaData = ['@context'=>'https://schema.org','@graph'=>[
    ['@type'=>'Service','@id'=>$siteUrl.'/services/dry-wall/#service','name'=>'Dry Wall','description'=>$currentService['description']??'','provider'=>['@id'=>$siteUrl.'/#organization'],'areaServed'=>['@type'=>'GeoCircle','geoMidpoint'=>['@type'=>'GeoCoordinates','latitude'=>'38.8153','longitude'=>'-91.1418'],'geoRadius'=>'80467'],'url'=>$canonicalUrl],
    ['@type'=>'BreadcrumbList','itemListElement'=>[['@type'=>'ListItem','position'=>1,'name'=>'Home','item'=>$siteUrl.'/'],['@type'=>'ListItem','position'=>2,'name'=>'Services','item'=>$siteUrl.'/services/'],['@type'=>'ListItem','position'=>3,'name'=>'Dry Wall']]],
...
<style>
/* ═══════════════════════════════════════════════════════════════
   /services/dry-wall/ — Premium tier ≥400L
   Signature: textured dot-grid overlay pattern on hero
   ═══════════════════════════════════════════════════════════════ */
...
.svc-hero::before { content:''; position:absolute; inset:0; background:linear-gradient(112deg,rgba(var(--color-primary-rgb),0.96) 0%,rgba(var(--color-primary-rgb),0.72) 50%,rgba(var(--color-primary-rgb),0.22) 100%); z-index:1; }
/* Signature: dot-grid texture overlay on hero */
.svc-hero::after { content:''; position:absolute; inset:0; background-image:radial-gradient(circle,rgba(255,255,255,0.07) 1px,transparent 1px); background-size:28px 28px; z-index:2; pointer-events:none; }
...
<!-- HERO -->
<section class="svc-hero" aria-label="Drywall installation and repair in Warrenton, MO">
  <div class="svc-hero-inner">
    <div class="svc-hero-text">
      <nav class="hero-breadcrumb" aria-label="Breadcrumb"><a href="/">Home</a><span>›</span><a href="/services/">Services</a><span>›</span><span aria-current="page">Dry Wall</span></nav>
      <span class="hero-eyebrow">Warrenton, MO — Warren County</span>
      <h1><span class="accent">Drywall</span><br>Installation &amp; Repair in Warrenton, MO</h1>
      <p class="hero-answer">A&amp;S Contracting Services installs, finishes, and repairs drywall for residential and commercial projects throughout Warrenton, MO and Warren County. New construction hanging, water damage rebuilds, texture matching, and Level 3 through Level 5 smooth finish — with written estimates before any work begins.</p>
      <div class="hero-trust-row">
        ...
        <span class="trust-pill"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg>Level 5 Finish Available</span>
      ...
      <div class="hero-cta-group">
        <a href="/contact/" class="btn-primary-svc">Get a Free Drywall Estimate</a>
        <a href="#drywall-process" class="btn-ghost-svc">How It Works</a>
      </div>
    </div>
    <aside class="hero-aside-card" aria-label="Quick estimate">
      <p class="aside-card-title">Request a Free Drywall Estimate</p>
      <form class="aside-form" action="<?php echo htmlspecialchars($formAction); ?>" method="POST">
        ...
        <input type="hidden" name="service"          value="Dry Wall">
        <div class="form-group"><label for="dw-name">Your Name</label><input type="text" id="dw-name" name="name" placeholder="Jane Smith" required></div>
        <div class="form-group"><label for="dw-phone">Phone</label><input type="tel" id="dw-phone" name="phone" placeholder="(573) 555-0100" required></div>
        <div class="form-group"><label for="dw-email">Email</label><input type="email" id="dw-email" name="email" placeholder="you@email.com" required></div>
        <div class="form-group"><label for="dw-msg">Description</label><textarea id="dw-msg" name="message" rows="2" placeholder="New install, patch repair, water damage, Level 5…"></textarea></div>
...
<!-- PROBLEM STATEMENT -->
<section class="problem-section" aria-label="When you need drywall work">
  <div class="container-svc">
    <p class="problem-pullquote">A poorly finished wall shows every flaw the moment <em>light hits it</em> at an angle — texture matching and finish level aren't details, they're the entire result.</p>
    <div class="bento-grid">
      <div class="bento-card reveal-up reveal-delay-1"><div class="bento-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M12 22s-8-4.5-8-10.8C4 6.1 7.8 2 12 2s8 4.1 8 9.2C20 17.5 12 22 12 22z"/></svg></div><h3>Water damage replacement</h3><p>Pipe leaks, roof infiltration, and HVAC condensation cause sagging, bubbling, and staining in drywall panels. Patching over compromised drywall is temporary — panels that have absorbed water need full replacement to prevent mold growth.</p></div>
      <div class="bento-card reveal-up reveal-delay-2"><div class="bento-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18"/></svg></div><h3>New construction finishing</h3><p>Newly framed spaces — room additions, finished basements, garage conversions — need drywall hung, taped, and finished before flooring and paint can begin. We manage the full drywall scope for new construction in Warren County.</p></div>
      <div class="bento-card reveal-up reveal-delay-3"><div class="bento-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><h3>Texture mismatch after repairs</h3><p>Visible patches after plumbing or electrical access — especially on ceilings — are a common complaint. We match knock-down, orange peel, and smooth textures on Warrenton-area homes so repairs aren't visible from across the room.</p></div>
      <div class="bento-card reveal-up reveal-delay-4"><div class="bento-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg></div><h3>Pre-paint Level 5 upgrade</h3><p>Homeowners switching to higher-sheen paints often discover that their existing Level 4 drywall shows tool marks and board seams clearly under gloss. A Level 5 skim-coat eliminates these imperfections before paint goes on.</p></div>
    </div>
  </div>
</section>
...
<!-- EXPERT POSITIONING -->
<section class="expert-section" aria-label="Why A&S for drywall">
  <div class="container-svc">
    <div class="expert-grid">
      <div class="reveal-left">
        <div><span class="big-stat-num">L5</span><br><span class="big-stat-label">Highest drywall finish grade — available on request</span></div>
        <ul class="differentiator-list">
          <li><div class="diff-check"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg></div><span class="diff-text"><strong>On-site texture inspection before quoting.</strong> We inspect the existing texture in person before estimating a patch — because telephone quotes on texture matching are unreliable. The right match requires seeing the wall, the lighting, and the adjacent surface condition.</span></li>
          <li><div class="diff-check"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg></div><span class="diff-text"><strong>Moisture barrier and mold-resistant board in wet areas.</strong> Kitchens, bathrooms, and laundry spaces get moisture-resistant or paperless glass-mat drywall by default — not standard gypsum — to resist the humidity cycles common in Missouri homes.</span></li>
          <li><div class="diff-check"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg></div><span class="diff-text"><strong>Full drywall scopes integrated into interior renovation projects.</strong> Drywall work with A&S is often part of a larger interior renovation — we coordinate with painting and flooring phases so each trade isn't waiting on another to finish.</span></li>
        </ul>
      </div>
      <div class="expert-image-wrap reveal-right">
        <img src="<?php echo $bodyPhoto1; ?>" alt="Drywall installation in Warrenton, MO by A&S Contracting Services" width="720" height="420" loading="lazy">
...
<!-- SERVICE BREAKDOWN -->
<section id="drywall-process" class="breakdown-section" aria-label="Drywall installation process">
  <div class="container-svc">
    <div class="breakdown-grid">
      <div class="breakdown-image reveal-left"><img src="<?php echo $bodyPhoto2; ?>" alt="Drywall finishing on Warren County home" width="640" height="480" loading="lazy"><span class="breakdown-image-tag">Our Work</span></div>
      <div class="reveal-right">
        <span class="eyebrow-label">The Process</span>
        <h2 class="section-h2">What's included in your drywall project with A&amp;S?</h2>
        <p class="answer-block">Every drywall project with A&amp;S Contracting Services includes a free on-site inspection, written estimate by square footage and finish level, board hanging, taping, multiple finish coats, sanding to agreed level, and job cleanup. Written price confirmed before any material is ordered.</p>
        <div class="process-steps">
          <div class="process-step"><div class="step-num">1</div><div><p class="step-title">Free On-Site Inspection &amp; Estimate</p><p class="step-desc">We measure the space, inspect framing or existing drywall condition, assess moisture history, and discuss finish level options before preparing a written estimate. For patch work, we inspect the existing texture in person.</p></div></div>
          <div class="process-step"><div class="step-num">2</div><div><p class="step-title">Material Selection &amp; Delivery</p><p class="step-desc">Board type (standard, moisture-resistant, fire-rated, or glass-mat) is confirmed based on location. Panels are delivered and staged before hanging begins — we don't start a job without material on site.</p></div></div>
          <div class="process-step"><div class="step-num">3</div><div><p class="step-title">Hanging &amp; Fastening</p><p class="step-desc">Panels are hung horizontally (industry standard for residential walls), fastened to framing at specified intervals, and cut around all openings. Ceilings are installed before walls in full-room scopes.</p></div></div>
          <div class="process-step"><div class="step-num">4</div><div><p class="step-title">Taping, Coating &amp; Finish</p><p class="step-desc">Paper tape is embedded in first coat over all seams and screw heads. Additional coats are applied and sanded between coats until the agreed finish level is achieved. Drying time between coats is respected — rushing this phase ruins the finish.</p></div></div>
          <div class="process-step"><div class="step-num">5</div><div><p class="step-title">Final Sanding, Priming &amp; Cleanup</p><p class="step-desc">After final sanding, the surface is primed — priming is required on new drywall before paint regardless of finish level. All dust and debris are removed before we leave the site.</p></div></div>
        </div>
      </div>
    </div>
  </div>
...
<!-- PROOF -->
<section style="padding:var(--space-3xl) 0;background:var(--color-bg);" aria-label="Drywall project photos">
  <div class="container-svc">
    <div style="text-align:center;margin-bottom:var(--space-2xl);" class="reveal-up"><span class="eyebrow-label">Recent Work</span><h2 class="section-h2" style="max-width:600px;margin:0 auto var(--space-sm);">What does completed drywall work look like near Warrenton?</h2><p class="answer-block" style="max-width:56ch;margin:0 auto;">Sample drywall projects completed by A&amp;S Contracting Services in Warrenton, MO and surrounding Warren County communities.</p></div>
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:var(--space-md);" class="reveal-up">
      <div style="border-radius:var(--radius-lg);overflow:hidden;box-shadow:var(--shadow);aspect-ratio:4/3;"><img src="<?php echo $bodyPhoto3; ?>" alt="Drywall installation completed on Warrenton, MO home" width="480" height="360" loading="lazy" style="width:100%;height:100%;object-fit:cover;display:block;"></div>
      <div style="border-radius:var(--radius-lg);overflow:hidden;box-shadow:var(--shadow);aspect-ratio:4/3;"><img src="<?php echo $bodyPhoto1; ?>" alt="Smooth drywall finish on Warren County residential home" width="480" height="360" loading="lazy" style="width:100%;height:100%;object-fit:cover;display:block;"></div>
...
<!-- COMPARISON -->
<section class="comparison-section" aria-label="A&S vs other drywall contractors">
  <div class="container-svc">
    <div class="comparison-intro reveal-up">
      <span class="eyebrow-label" style="color:var(--color-accent);">Why A&amp;S?</span>
      <h2 class="section-h2-light">How does A&amp;S compare to other <span style="color:var(--color-accent);">drywall contractors</span> in Warren County?</h2>
      <p style="color:rgba(255,255,255,0.6);max-width:54ch;margin:var(--space-sm) auto 0;font-size:0.95rem;line-height:1.75;">We inspect textures in person, offer Level 5 skim-coat, use moisture-resistant board in wet areas, and prime before we leave — every project in Warrenton, MO.</p>
    </div>
    <div class="comparison-table reveal-up" role="table">
      ...
      <div class="comp-cell feature">Level 5 skim-coat available</div><div class="comp-cell ours check">✓ On request</div><div class="comp-cell cross">Rarely offered</div>
      <div class="comp-cell feature">Texture inspection in person before quote</div><div class="comp-cell ours check">✓ Every patch job</div><div class="comp-cell cross">Often phone-quoted</div>
      <div class="comp-cell feature">Moisture-resistant board in wet areas</div><div class="comp-cell ours check">✓ Standard</div><div class="comp-cell cross">Sometimes skipped</div>
      <div class="comp-cell feature">Primer coat before leaving site</div><div class="comp-cell ours check">✓ Always</div><div class="comp-cell cross">Often extra charge</div>
...
<!-- FAQ -->
<section class="faq-section" aria-label="Drywall FAQ">
  <div class="container-svc">
    <div class="faq-grid">
      <div class="faq-sidebar reveal-left"><div class="faq-sidebar-img"><img src="<?php echo $heroPhoto; ?>" alt="Drywall installation in Warrenton, MO" width="560" height="260" loading="lazy"></div><div class="faq-sidebar-note"><strong>Specific drywall question?</strong><br>Contact us — we respond to all Warren County inquiries within one business day.</div></div>
      <div class="reveal-right">
        <span class="eyebrow-label">Common Questions</span>
        <h2 class="section-h2">What do Warrenton homeowners ask about drywall?</h2>
        <p class="answer-block" style="margin:var(--space-sm) 0 var(--space-xl);">The most common drywall questions from Warren County homeowners before scheduling a free estimate.</p>
        <div class="faq-list">
...
<!-- FINAL CTA -->
<section class="final-cta-section" aria-label="Free drywall estimate">
  <div class="container-svc"><div style="max-width:680px;margin:0 auto;" class="reveal-up">
    ...
    <h2 class="section-h2">Ready for drywall work in Warrenton?</h2>
    <p class="answer-block" style="max-width:56ch;margin:var(--space-sm) auto var(--space-xl);">Free on-site drywall estimates for Warrenton, MO and Warren County. Written pricing, Level 3–5 finish options, licensed crew, and appointments available this week.</p>
    <div class="cta-btn-group"><a href="/contact/" class="btn-accent-lg">Get My Free Drywall Estimate</a><a href="/services/" class="btn-dark-outline">View All Services</a></div>
  </div></div>
</section>
